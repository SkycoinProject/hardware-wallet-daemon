...
func (_m *MockGatewayer) ApplySettings(usePassphrase bool, label string) (wire.Message, error) {
...
func (_m *MockGatewayer) SignMessage(addressN int, message string) (wire.Message, error) {
